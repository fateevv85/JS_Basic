...
function respawn() {
    ...
    //к текущему классу добавляют новый, сложным способом
...
function move() {
    ...
    // if (notSnakeUnit(new_unit) && new_unit !== undefined) {
...
function createFood() {
    ...
    while (!foodCreated) {
        ...
        // console.log(food_cell);
        //<td class="game-table-cell cell-11-18"></td>

        var food_cell_classes = food_cell.getAttribute('class').split(' ');
        // console.log(food_cell_classes);
        // ["game-table-cell", "cell-11-18"]
...
function finishTheGame() {
    ...
    document.querySelector(".game_over").innerHTML = "<span>Game Over!</span>" + "<br>" + "Ваш счет: " + score;
}
